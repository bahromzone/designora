...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "lesson_reminders", sa.Boolean(), nullable=False, server_default=sa.true()
        ),
        sa.Column(
            "deadline_reminders", sa.Boolean(), nullable=False, server_default=sa.true()
        ),
        sa.Column(
            "review_reminders", sa.Boolean(), nullable=False, server_default=sa.true()
        ),
        sa.Column(
            "marketing_enabled", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
        sa.Column(
            "frequency", sa.String(length=20), nullable=False, server_default="instant"
        ),
        sa.Column(
            "quiet_start", sa.String(length=5), nullable=False, server_default="22:00"
        ),
        sa.Column(
            "quiet_end", sa.String(length=5), nullable=False, server_default="08:00"
        ),
        sa.Column(
            "timezone",
            sa.String(length=80),
