...
from app.routers import (
    admin_courses, admin_payments, admin_users, analytics, assignments, assignments_upload, auth, blog, calendar, certificates, checkout_experience, course_builder, course_forum, courses_api, dashboard, discovery, forum, gamification, google, instructor, instructor_applications, instructor_analytics, instructors, learning, learning_paths, media, moderation, monetization, notes, notifications, pages, payments, payment_history, portfolio, privacy, profile, qa, quiz, referrals, reviews, saved_courses, superadmin, system, token, uploads, users, video_uploads,
)
...
setup_admin(app)
for r in (
    profile.router, admin_courses.router, admin_payments.router, admin_users.router, analytics.router, assignments.router, assignments_upload.router, blog.router, calendar.router, certificates.router, checkout_experience.router, course_builder.router, course_forum.router, courses_api.router, dashboard.router, discovery.router, forum.router, gamification.router, google.router, instructor_applications.router, instructor.router, instructor_analytics.router, instructors.router, learning.router, learning_paths.router, media.router, moderation.router, monetization.router, notes.router, notifications.router, pages.router, payments.router, payment_history.router, portfolio.router, privacy.router, profile.router, qa.router, quiz.router, referrals.router, reviews.router, saved_courses.router, superadmin.router, system.router, token.router, uploads.router, video_uploads.router, users.router, public_router, auth.router,
):
