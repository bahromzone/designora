...
setup_admin(app)
for r in (
    profile.router, admin_courses.router, admin_payments.router, admin_users.router, analytics.router, assignments.router, assignments_upload.router, blog.router, calendar.router, certificates.router, checkout_experience.router, course_builder.router, course_forum.router, courses_api.router, dashboard.router, discovery.router, forum.router, gamification.router, google.router, instructor_applications.router, instructor.router, instructor_analytics.router, instructors.router, learning.router, learning_paths.router, media.router, moderation.router, monetization.router, notes.router, notifications.router, pages.router, payments.router, payment_history.router, portfolio.router, privacy.router, qa.router, quiz.router, referrals.router, reviews.router, saved_courses.router, superadmin.router, system.router, token.router, uploads.router, video_uploads.router, users.router, public_router, auth.router,
):
