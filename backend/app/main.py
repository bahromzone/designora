...
from app.routers import admin_courses, analytics, assignments, assignments_upload, auth, blog, certificates, courses_api, discovery, forum, google, instructor, learning, learning_paths, media, notes, notifications, payments, portfolio, privacy, profile, qa, quiz, referrals, reviews, system, token, users
...
setup_admin(app)
for item in [profile, admin_courses, courses_api, learning, learning_paths, instructor, assignments, assignments_upload, portfolio]:
    app.include_router(item.router)
app.include_router(public_router)
for item in [auth, google, users, discovery, quiz, reviews, qa, notes, certificates, media, blog, forum, notifications, referrals, analytics, payments, privacy, system, token]:
    app.include_router(item.router)
