...
CI enforces ESLint, Prettier, 70% coverage, prerender output, and Lighthouse independently. Lighthouse budgets: performance 80, accessibility 90, best practices 85, SEO 90, LCP 2.5s, CLS 0.1, total blocking time 300ms.
