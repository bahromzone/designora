...
CI has separate lint/format, coverage, prerender, and Lighthouse gates. Lighthouse budgets: performance 80, accessibility 90, best practices 85, SEO 90, LCP 2.5s, CLS 0.1, total blocking time 300ms.
