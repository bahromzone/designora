    ...
    <AppShell>
      ...
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route path="/community/:courseId" element={p(<CourseCommunityPage />)} />
          <Route path="/community/:courseId/thread/:threadId" element={p(<CourseCommunityPage />)} />
          ...
          <Route path="/tolov/natija/:orderId" element={p(<CheckoutResultPage />)} />
          <Route path="/profil" element={p(<ProfilePage />)} />
          <Route path="/portfolio" element={p(<PortfolioBuilderPage />)} />
          <Route path="/instruktor-boshlash" element={p(<InstructorApplyPage />)} />
          <Route path="/instruktor-panel" element={ins(<InstructorDashboardPage />)} />
          <Route path="/instruktor-analytics" element={ins(<InstructorAnalyticsPage />)} />
          <Route path="/instruktor-boshqaruv" element={ins(<InstructorManagePage />)} />
          <Route path="/instruktor/kurs/:courseId" element={ins(<InstructorCourseEditPage />)} />
          <Route path="/instruktor/review/:assignmentId" element={ins(<InstructorReviewPage />)} />
          ...
          <Route path="/admin/instructor-applications" element={ad(<InstructorApplicationsPage />)} />
          <Route path="/admin/payments" element={ad(<AdminPaymentsPage />)} />
          <Route path="/admin/moderation" element={ad(<AdminModerationPage />)} />
          ...
          <Route path="/superadmin/audit" element={sa(<SuperadminAuditPage />)} />
