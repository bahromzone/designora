...
const adminLinks = [
  ...
  ["Users", "/admin/users"],
  ["Instructor arizalari", "/admin/instructor-applications"],
  ["Orders & payments", "/admin/payments"],
  ["Moderatsiya", "/admin/moderation"],
    ...
    <div className="admin-workspace">
      <aside className="admin-sidebar">
        <Link to="/" className="admin-brand">
          ...
          <span className="admin-brand-copy">
            DESIGNORA<small>{superadmin ? "CONTROL ROOM" : "OPERATIONS"}</small>
          </span>
        </Link>
      ...
      <main className="admin-main">
        <div className="admin-main-top">
          <span>
            {superadmin ? "Designora control" : "Designora operations"}
          </span>
