...
const SOCIAL_LINKS = [
  {
    ...
    icon: (
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M12 2.16c3.2 0 3.58.01 4.85.07 1.17.05 1.8.25 2.23.41.56.22.96.48 1.38.9.42.42.68.82.9 1.38.16.42.36 1.06.41 2.23.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.05 1.17-.25 1.8-.41 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.42.16-1.06.36-2.23.41-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-1.17-.05-1.8-.25-2.23-.41a3.7 3.7 0 0 1-1.38-.9 3.7 3.7 0 0 1-.9-1.38c-.16-.42-.28-0.81-.32-1.71C2.17 15.58 2.16 15.2 2.16 12s.01-3.58.07-4.85c.04-.9.19-1.38.32-1.71.17-.43.37-.74.69-1.06.32-.32.63-.52 1.06-.69.33-.13.81-.28 1.71-.32C8.42 2.17 8.8 2.16 12 2.16z" />
      </svg>
    ),
  },
  {
