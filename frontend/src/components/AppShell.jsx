            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 group cursor-pointer w-max">
                <svg width="28" height="28" viewBox="0 0 32 32" fill="none" className="group-hover:scale-110 transition-transform duration-300">
                  <path d="M16 2L2 9L16 16L30 9L16 2Z" fill="url(#footer_grad1)" />
                  <path d="M2 23L16 30L30 23V9L16 16L2 9V23Z" fill="url(#footer_grad2)" opacity="0.9"/>
                  <defs>
                    <linearGradient id="footer_grad1" x1="2" y1="9" x2="30" y2="9" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#EC4899" />
                      <stop offset="1" stopColor="#6366F1" />
                    </linearGradient>
                    <linearGradient id="footer_grad2" x1="16" y1="30" x2="16" y2="9" gradientUnits="userSpaceOnUse">
              ...
              <div className="flex gap-4 mt-8">
                {['Instagram', 'Telegram', 'YouTube', 'Twitter'].map((social) => (
                  <button key={social} className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center border border-gray-200 text-slate-400 hover:text-indigo-500 hover:border-indigo-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300">
              ...
              {FOOTER_LINKS.map((col) => (
                <div key={col.title}>
                  ...
                  <ul className="space-y-4">
                    {col.links.map((link) => (
                      <li key={link}>
                        <a href="#" className="text-sm text-slate-500 hover:text-indigo-600 transition-colors duration-200">
                          {link}
                        </a>
                      </li>
                    ))}
