...
export default function RecentNoteCard({ note: providedNote }) {
  ...
  return (
    <aside
      className="mx-auto mt-8 flex max-w-[1132px] items-center justify-between gap-5 border-y py-5"
    ...
    >
      ...
      <Link
        ...
        to={`/organish/${note.course_id}?lesson=${note.lesson_id}&t=${note.timestamp_seconds}`}
      >
        Note’ga qaytish
      </Link>
    </aside>
