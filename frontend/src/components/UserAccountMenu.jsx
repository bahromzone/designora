...
export default function UserAccountMenu() {
  ...
  return (
    <div ref={ref} className="fixed right-[8.5rem] top-4 z-50 md:right-[9.5rem] md:top-5">
      <button
        type="button"
      ...
      {open && (
        <div role="menu" className="absolute right-0 mt-3 w-[min(22rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-2xl">
          ...
          <button type="button" onClick={signOut} className="w-full border-t border-slate-100 px-3 py-3 text-left text-sm font-bold text-red-600 hover:bg-red-50">Chiqish</button>
        </div>
      )}
    </div>
  );
