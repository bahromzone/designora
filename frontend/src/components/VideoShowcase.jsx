...
export default function VideoShowcase() {
  ...
  return (
    <section className="relative z-10 mb-16 px-6 py-6 sm:py-8">
      <div className="group relative mx-auto max-w-4xl overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 shadow-xl sm:rounded-3xl">
        {!isPlaying ? (
          <div className="relative flex aspect-video w-full items-center justify-center overflow-hidden p-6 text-white sm:p-10">
            ...
            <button
              ...
              className="group/btn relative z-10 flex h-16 w-16 transform items-center justify-center rounded-full border border-white/40 bg-white/20 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:scale-110 hover:bg-white/30 focus:outline-none focus:ring-4 focus:ring-purple-400/50 active:scale-95 sm:h-20 sm:w-20"
            >
