...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("designora-token-refreshed", onRefreshed);
  }, []);
  ...
  return <AuthContext.Provider value={{ token, user, loading, isAuthenticated: Boolean(token && user), login, register, loginWithToken, logout, refreshProfile }}>{children}</AuthContext.Provider>;
}
