...
// Google OAuth kirish nuqtasi (backend: GET /auth/google -> redirect).
...
export const authApi = {
  ...
  // Parolni tiklash: email bo'yicha havola yuboradi (backend generic javob qaytaradi).
  ...
  // Yangi parol o'rnatish (reset-password sahifasidan token bilan).
