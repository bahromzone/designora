  ...
  return (
    <section className="paths-shell">
      <header>
        ...
        <h1>Maqsaddan natijagacha aniq yo‘l</h1>
        <p>
          Prerequisite, progress va yakuniy loyiha bilan tuzilgan 4 ta
      ...
      <div className="paths-grid">
        {paths.map((path) => (
          ...
          >
            <span>
              {path.courses_count} kurs ·{" "}
              {Math.round(path.duration_minutes / 60)} soat
            </span>
            <h2>{path.title}</h2>
