    ...
    <section className="shell py-12 sm:py-16">
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="card rounded-2xl p-6 sm:p-8 lg:p-10">
          ...
          >
            Hisob oching va liboslar bo'yicha amaliy darslar, styling va
            brending yo'nalishlarini darhol boshlang.
          </p>
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col justify-end p-8 text-white sm:p-10">
            ...
            >
              Designora nazariya va vizual ilhomni real moda mahsulotiga olib
              boradigan platforma.
            </p>
          </div>
        </div>
